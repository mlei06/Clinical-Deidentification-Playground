...
interface ReviewerDualPaneProps {
  left: ReactNode;
  right: ReactNode;
...
/**
 * Synced vertical scroll: source (left) and preview output (right).
 * When outputCollapsed, only the left pane is shown full width.
 */
export default function ReviewerDualPane({
  left,
  right,
  leftHeader,
  rightHeader,
  outputCollapsed = false,
}: ReviewerDualPaneProps) {
  ...
  return (
    <div className="flex min-h-0 min-w-0 flex-1 divide-x divide-gray-200">
      <div
        className={
          outputCollapsed
