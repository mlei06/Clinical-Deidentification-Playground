              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-gray-100 bg-gray-50">
                    ...
                    <th className="px-3 py-2 text-left text-xs font-medium text-gray-500">Pipeline</th>
                    <th className="px-3 py-2 text-left text-xs font-medium text-gray-500">Command</th>
                    <th className="px-3 py-2 text-left text-xs font-medium text-gray-500">Source</th>
                    <th className="px-3 py-2 text-right text-xs font-medium text-gray-500">Docs</th>
                    <th className="px-3 py-2 text-right text-xs font-medium text-gray-500">Spans</th>
