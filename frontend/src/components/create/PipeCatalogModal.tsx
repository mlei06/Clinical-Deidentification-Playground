...
import { X, Search, AlertCircle, Shuffle, Scissors, Search as SearchIcon } from 'lucide-react';
...
export default function PipeCatalogModal({ open, onClose, onPick }: PipeCatalogModalProps) {
  const { data: pipeTypes } = usePipeTypes();
  const [q, setQ] = useState('');

  const groups = useMemo(() => {
    const base = buildPipeCatalogGroups(pipeTypes);
